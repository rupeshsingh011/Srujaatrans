...
const Contact = () => {
  ...
  const email = t('footer.email') || 'jobs@srujaatrans.com';
          ...
          <div className="contact-left">
            ...
            <div className="contact-info">
              <div className="contact-card">
                ...
                <a href={`tel:${phone}`} className="contact-data">{phone}</a>
              </div>
              <div className="contact-card">
                <div className="contact-label">{t('contact.email')}</div>
                <a href={`mailto:${email}`} className="contact-data">{email}</a>
              </div>
              <div className="contact-card">
                ...
                <div className="social-wrap">
                  ...
                  <a href={`https://wa.me/${phoneDigits}`} className="social-link" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
