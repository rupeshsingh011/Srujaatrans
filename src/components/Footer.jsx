        ...
        <div className="footer-main">
          ...
          <div className="footer-left-col">
            <Link to="/" className="footer-logo">
              <img src="/logo.png" alt="Srujaa Logo" />
            </Link>
            <div className="footer-text-wrap">
              <p className="footer-head-text" dangerouslySetInnerHTML={{ __html: t('footer.title') }}></p>
              <div className="footer-payment-icons">
                <img src="https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" alt="PayPal" />
                <img src="https://upload.wikimedia.org/wikipedia/commons/e/e7/Payoneer_logo.svg" alt="Payoneer" className="payoneer-icon" />
                <img src="https://upload.wikimedia.org/wikipedia/commons/e/e1/UPI-Logo-vector.svg" alt="UPI" />
                <img src="https://upload.wikimedia.org/wikipedia/commons/2/28/HDFC_Bank_Logo.svg" alt="HDFC" className="hdfc-icon" />
                <img src="/deutsche-bank-logo.png" alt="Deutsche Bank" className="deutsche-icon" />
              </div>
            </div>
          </div>
          ...
          <div className="footer-right-cols">
            ...
            <div className="footer-nav-col">
              ...
              <ul className="footer-nav-list">
                ...
                <li><Link to="/payment-methods">{t('footer.payment')}</Link></li>

              </ul>
            </div>

            <div className="footer-nav-col">
              <h4 className="footer-nav-title">{t('footer.follow')}</h4>
              <ul className="footer-nav-list footer-social-list">
                ...
                <li>
                  <a href="#">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 10.054 10.054 0 01-3.127 1.184 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" /></svg>
                    Twitter
                  </a>
                </li>
              </ul>
