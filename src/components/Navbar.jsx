  ...
  return (
    <header className={`navbar ${isContactPage ? 'navbar-solid' : ''} ${isScrolled ? 'scrolled' : ''}`}>
      <div className="container nav-wrap">
        ...
        <nav className="center-nav desktop-only">
        ...
        <div className="nav-right">
          ...
          <div className="lang-switcher-container">
            ...
            >
              <img
                src={`/${i18n.language?.startsWith('mr') || i18n.language?.startsWith('hi') ? 'in' : i18n.language?.startsWith('de') ? 'ger' : 'us'}.png`}
            ...
            {isLangOpen && (
              <div className="lang-dropdown">
                ...
                >
                  <img src="/us.png" alt="US Flag" className="lang-flag" /> EN
                </div>
                <div
                  className="lang-option"
                  onClick={() => { i18n.changeLanguage('mr'); setIsLangOpen(false); }}
                >
                  <img src="/in.png" alt="Indian Flag" className="lang-flag" /> MR
                </div>
                <div
                  className="lang-option"
                  onClick={() => { i18n.changeLanguage('hi'); setIsLangOpen(false); }}
                >
                  <img src="/in.png" alt="Indian Flag" className="lang-flag" /> HI
                </div>
                <div
                  className="lang-option"
                  onClick={() => { i18n.changeLanguage('de'); setIsLangOpen(false); }}
                >
                  <img src="/ger.png" alt="German Flag" className="lang-flag" /> DE
                </div>
              </div>
            )}
          </div>
